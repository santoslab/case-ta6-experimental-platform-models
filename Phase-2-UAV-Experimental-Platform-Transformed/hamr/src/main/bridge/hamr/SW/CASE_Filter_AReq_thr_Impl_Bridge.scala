...
@record class CASE_Filter_AReq_thr_Impl_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val entryPoints : Bridge.EntryPoints =
    CASE_Filter_AReq_thr_Impl_Bridge.EntryPoints(
      id,
      ...
      CASE_Filter_AReq_thr_Impl_Impl(api)
    )
}

object CASE_Filter_AReq_thr_Impl_Bridge {
  ...
  @record class EntryPoints(
    ...
    component : CASE_Filter_AReq_thr_Impl_Impl ) extends Bridge.EntryPoints {
