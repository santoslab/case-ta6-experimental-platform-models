...
@record class CASE_Filter_OR_thr_Impl_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val api : CASE_Filter_OR_thr_Impl_Bridge.Api =
    CASE_Filter_OR_thr_Impl_Bridge.Api(
      id,
      filter_in.id,
      filter_out.id
    )
  ...
  val entryPoints : Bridge.EntryPoints =
    CASE_Filter_OR_thr_Impl_Bridge.EntryPoints(
      id,
      ...
      CASE_Filter_OR_thr_Impl_Impl(api)
    )
}

object CASE_Filter_OR_thr_Impl_Bridge {
  ...
  @record class EntryPoints(
    CASE_Filter_OR_thr_Impl_BridgeId : Art.BridgeId,
    ...
    component : CASE_Filter_OR_thr_Impl_Impl ) extends Bridge.EntryPoints {
