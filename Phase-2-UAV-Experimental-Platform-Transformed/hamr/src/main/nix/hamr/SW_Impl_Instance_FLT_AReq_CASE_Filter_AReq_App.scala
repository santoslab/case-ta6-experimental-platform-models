...
object SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq.entryPoints
  val appPortId: Art.PortId = IPCPorts.SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)
  val filter_inPortId: Art.PortId = Arch.SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq.filter_in.id
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq_App starting ...")
