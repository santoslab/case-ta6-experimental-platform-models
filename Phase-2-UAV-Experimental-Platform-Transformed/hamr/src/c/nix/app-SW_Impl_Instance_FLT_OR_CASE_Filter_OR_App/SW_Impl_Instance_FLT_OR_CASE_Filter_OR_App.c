...
void atExit(int signum) {
  ...
  StackFrame sf = NULL;
  #endif
  hamr_SW_Impl_Instance_FLT_OR_CASE_Filter_OR_App_atExit(SF_LAST);
}
...
int main(int argc, char *argv[]) {
  ...
  DeclNewStackFrame(NULL, "SW_Impl_Instance_FLT_OR_CASE_Filter_OR_App.scala", "hamr.SW_Impl_Instance_FLT_OR_CASE_Filter_OR_App", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_FLT_OR_CASE_Filter_OR_App_main(SF &t_args);
}