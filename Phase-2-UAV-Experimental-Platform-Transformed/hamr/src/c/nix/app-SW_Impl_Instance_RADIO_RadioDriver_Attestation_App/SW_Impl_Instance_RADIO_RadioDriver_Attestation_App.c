...
void atExit(int signum) {
  ...
  StackFrame sf = NULL;
  #endif
  hamr_SW_Impl_Instance_RADIO_RadioDriver_Attestation_App_atExit(SF_LAST);
}
...
int main(int argc, char *argv[]) {
  ...
  DeclNewStackFrame(NULL, "SW_Impl_Instance_RADIO_RadioDriver_Attestation_App.scala", "hamr.SW_Impl_Instance_RADIO_RadioDriver_Attestation_App", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_RADIO_RadioDriver_Attestation_App_main(SF &t_args);
}