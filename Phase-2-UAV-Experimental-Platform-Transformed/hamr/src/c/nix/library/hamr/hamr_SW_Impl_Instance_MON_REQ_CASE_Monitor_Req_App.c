...
Z hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_main(STACK_FRAME IS_948B60 args) {
  ...
  hamr_PlatformNix_receive(SF (Tuple2_D0E3BB) &t_4, (Option_882048) hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_appPortIdOpt(SF_LAST));
  ...
  hamr_PlatformNix_receive(SF (Tuple2_D0E3BB) &t_6, (Option_882048) hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_appPortIdOpt(SF_LAST));
  ...
  while(t_73_5) {
    ...
    hamr_PlatformNix_receiveAsync(SF (Option_02FA6D) &t_8, (Option_882048) hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_appPortIdOpt(SF_LAST));
...
static inline B hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_34_12_02FA6D(STACK_FRAME_SF Option_02FA6D t_0, hamr_Base_Types_Bits_Payload *_v_34_21) {
...
static inline B hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_35_12_02FA6D(STACK_FRAME_SF Option_02FA6D t_0, art_DataContent *_v_35_21) {
  if (!Some_E9D1E5__is(SF t_0)) return F;
  *_v_35_21 = (art_DataContent) Tuple2_D0E3BB_2(Some_E9D1E5_value_(Some_E9D1E5__as(SF t_0)));
  return T;
}

static inline B hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_36_12_02FA6D(STACK_FRAME_SF Option_02FA6D t_0) {
  if (!None_93AA2B__is(SF t_0)) return F;
  return T;
}

static inline B hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_39_12_02FA6D(STACK_FRAME_SF Option_02FA6D t_5, hamr_Base_Types_Bits_Payload *_v_39_21) {
...
static inline B hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_40_12_02FA6D(STACK_FRAME_SF Option_02FA6D t_5, art_DataContent *_v_40_21) {
  if (!Some_E9D1E5__is(SF t_5)) return F;
  *_v_40_21 = (art_DataContent) Tuple2_D0E3BB_2(Some_E9D1E5_value_(Some_E9D1E5__as(SF t_5)));
  return T;
}

static inline B hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_41_12_02FA6D(STACK_FRAME_SF Option_02FA6D t_5) {
...
Unit hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute(STACK_FRAME_ONLY) {
  ...
  hamr_PlatformNix_receiveAsync(SF (Option_02FA6D) &t_1, (Option_882048) hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_observedPortIdOpt(SF_LAST));
  Option_02FA6D t_0 = ((Option_02FA6D) &t_1);
  B match_33_14 = F;
  if (!match_33_14) {
    hamr_Base_Types_Bits_Payload v_34_21;
    match_33_14 = hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_34_12_02FA6D(SF t_0, &v_34_21);
    if (match_33_14) {

      sfUpdateLoc(34);
      hamr_ArtNix_updateData(SF hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_observedPortId(SF_LAST), (art_DataContent) v_34_21);
    }
  }
  if (!match_33_14) {
    art_DataContent v_35_21;
    match_33_14 = hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_35_12_02FA6D(SF t_0, &v_35_21);
    if (match_33_14) {
  ...
  if (!match_33_14) {
    match_33_14 = hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_36_12_02FA6D(SF t_0);
    if (match_33_14) {
    }
  }
  ...
  hamr_PlatformNix_receiveAsync(SF (Option_02FA6D) &t_6, (Option_882048) hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_reference_1PortIdOpt(SF_LAST));
  Option_02FA6D t_5 = ((Option_02FA6D) &t_6);
  B match_38_14 = F;
  if (!match_38_14) {
    hamr_Base_Types_Bits_Payload v_39_21;
    match_38_14 = hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_39_12_02FA6D(SF t_5, &v_39_21);
    if (match_38_14) {

      sfUpdateLoc(39);
      hamr_ArtNix_updateData(SF hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_reference_1PortId(SF_LAST), (art_DataContent) v_39_21);
    }
  }
  if (!match_38_14) {
    art_DataContent v_40_21;
    match_38_14 = hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_40_12_02FA6D(SF t_5, &v_40_21);
    if (match_38_14) {
  ...
  if (!match_38_14) {
    match_38_14 = hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App_compute_extract_41_12_02FA6D(SF t_5);
    if (match_38_14) {
    }
  }
