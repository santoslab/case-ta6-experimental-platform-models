...
void hamr_Drivers_UARTDriver_Impl_Bridge_apply(STACK_FRAME hamr_Drivers_UARTDriver_Impl_Bridge this, Z id, String name, art_DispatchPropertyProtocol dispatchProtocol, Option_9AF35E dispatchTriggers, art_Port_45E54D recv_data, art_Port_45E54D MissionCommand, art_Port_45E54D send_data, art_Port_45E54D AirVehicleState) {
  ...
  IS_820232_up(&t_1, 3, (art_UPort) hamr_Drivers_UARTDriver_Impl_Bridge_AirVehicleState_(this));
  ...
  IS_820232_up(&t_5, 1, (art_UPort) hamr_Drivers_UARTDriver_Impl_Bridge_AirVehicleState_(this));
  ...
  hamr_Drivers_UARTDriver_Impl_Bridge_Api_apply(SF &t_6, hamr_Drivers_UARTDriver_Impl_Bridge_id_(this), art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_recv_data_(this)), art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_MissionCommand_(this)), art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_send_data_(this)), art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_AirVehicleState_(this)));
  ...
  hamr_Drivers_UARTDriver_Impl_Bridge_EntryPoints_apply(SF &t_7, hamr_Drivers_UARTDriver_Impl_Bridge_id_(this), art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_recv_data_(this)), art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_MissionCommand_(this)), art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_send_data_(this)), art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_AirVehicleState_(this)), (Option_9AF35E) hamr_Drivers_UARTDriver_Impl_Bridge_dispatchTriggers_(this), (hamr_Drivers_UARTDriver_Impl_Impl) (&t_8));
