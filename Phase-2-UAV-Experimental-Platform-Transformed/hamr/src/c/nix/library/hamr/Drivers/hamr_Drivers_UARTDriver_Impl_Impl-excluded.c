...
Unit hamr_Drivers_UARTDriver_Impl_Impl_initialise_(STACK_FRAME hamr_Drivers_UARTDriver_Impl_Impl this) {
  ...
  sfUpdateLoc(19);
  DeclNewOption_30119F(_apiUsage_MissionCommand);
  ...
  hamr_Drivers_UARTDriver_Impl_Bridge_Api_sendAirVehicleState_(SF hamr_Drivers_UARTDriver_Impl_Impl_api_(this), (IS_C4F575) ((IS_C4F575) &t_3));
}
