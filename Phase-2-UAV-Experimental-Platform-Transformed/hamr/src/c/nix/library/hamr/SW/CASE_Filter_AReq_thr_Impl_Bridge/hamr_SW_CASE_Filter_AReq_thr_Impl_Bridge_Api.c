...
B hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api__ne(hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this, hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api other);
...
void hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_string_(STACK_FRAME String result, hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Bridge.scala", "hamr.SW.CASE_Filter_AReq_thr_Impl_Bridge.Api", "string", 0);
...
B hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api__is(STACK_FRAME void* this);
hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api__as(STACK_FRAME void *this);
...
void hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_apply(STACK_FRAME hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this, Z id, Z filter_in_Id, Z filter_out_Id) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Bridge.scala", "hamr.SW.CASE_Filter_AReq_thr_Impl_Bridge.Api", "apply", 0);
  this->id = id;
...
Unit hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_logInfo_(STACK_FRAME hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this, String msg) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Bridge.scala", "hamr.SW.CASE_Filter_AReq_thr_Impl_Bridge.Api", "logInfo", 0);

  sfUpdateLoc(78);
  art_Art_logInfo(SF hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_id_(this), (String) msg);
}
...
Unit hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_logDebug_(STACK_FRAME hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this, String msg) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Bridge.scala", "hamr.SW.CASE_Filter_AReq_thr_Impl_Bridge.Api", "logDebug", 0);

  sfUpdateLoc(82);
  art_Art_logDebug(SF hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_id_(this), (String) msg);
}
...
Unit hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_logError_(STACK_FRAME hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this, String msg) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Bridge.scala", "hamr.SW.CASE_Filter_AReq_thr_Impl_Bridge.Api", "logError", 0);

  sfUpdateLoc(86);
  art_Art_logError(SF hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_id_(this), (String) msg);
}

static inline B hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_getfilter_in_extract_63_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this, IS_C4F575 *_v_63_43) {
...
static inline B hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_getfilter_in_extract_64_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this, art_DataContent *_v_64_19) {
  if (!Some_D29615__is(SF t_0)) return F;
  *_v_64_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_0));
  return T;
}

static inline B hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_getfilter_in_extract_67_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this) {
  return T;
}
...
void hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_getfilter_in_(STACK_FRAME Option_30119F result, hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Bridge.scala", "hamr.SW.CASE_Filter_AReq_thr_Impl_Bridge.Api", "getfilter_in", 0);

  sfUpdateLoc(62);
  DeclNewOption_30119F(_value);
  Option_30119F value;
  DeclNewOption_8E9F45(t_1);
  art_Art_getValue(SF (Option_8E9F45) &t_1, hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_filter_in_Id_(this));
  Option_8E9F45 t_0 = ((Option_8E9F45) &t_1);
  B match_62_49 = F;
  if (!match_62_49) {
    IS_C4F575 v_63_43;
    match_62_49 = hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_getfilter_in_extract_63_14_8E9F45(SF t_0, this, &v_63_43);
    if (match_62_49) {
  ...
  if (!match_62_49) {
    ...
    match_62_49 = hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_getfilter_in_extract_64_14_8E9F45(SF t_0, this, &v_64_19);
    if (match_62_49) {
      ...
      art_Art_logError(SF hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_id_(this), (String) ((String) &t_3));
  ...
  if (!match_62_49) {
    match_62_49 = hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_getfilter_in_extract_67_14_8E9F45(SF t_0, this);
    if (match_62_49) {
...
Unit hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_sendfilter_out_(STACK_FRAME hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api this, IS_C4F575 value) {
  DeclNewStackFrame(caller, "CASE_Filter_AReq_thr_Impl_Bridge.scala", "hamr.SW.CASE_Filter_AReq_thr_Impl_Bridge.Api", "sendfilter_out", 0);

  sfUpdateLoc(73);
  DeclNewhamr_Base_Types_Bits_Payload(t_0);
  hamr_Base_Types_Bits_Payload_apply(SF &t_0, (IS_C4F575) value);
  art_Art_putValue(SF hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_Api_filter_out_Id_(this), (art_DataContent) (&t_0));
}