...
void hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_apply(STACK_FRAME hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge this, Z id, String name, art_DispatchPropertyProtocol dispatchProtocol, Option_9AF35E dispatchTriggers, art_Port_45E54D observed, art_Port_45E54D reference_1) {
  ...
  hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_Api_apply(SF &t_6, hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_id_(this), art_Port_45E54D_id_(hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_observed_(this)), art_Port_45E54D_id_(hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_reference_1_(this)));
  ...
  hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_EntryPoints_apply(SF &t_7, hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_id_(this), art_Port_45E54D_id_(hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_observed_(this)), art_Port_45E54D_id_(hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_reference_1_(this)), (Option_9AF35E) hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_dispatchTriggers_(this), (hamr_SW_CASE_Monitor_Req_thr_Impl_Impl) (&t_8));
