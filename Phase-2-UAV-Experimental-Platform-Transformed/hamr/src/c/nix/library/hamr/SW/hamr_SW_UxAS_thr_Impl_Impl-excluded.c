...
Unit hamr_SW_UxAS_thr_Impl_Impl_initialise_(STACK_FRAME hamr_SW_UxAS_thr_Impl_Impl this) {
  ...
  sfUpdateLoc(18);
  DeclNewOption_30119F(_apiUsage_AutomationRequest);
  ...
  sfUpdateLoc(19);
  DeclNewOption_30119F(_apiUsage_AirVehicleState);
  ...
  sfUpdateLoc(20);
  DeclNewOption_30119F(_apiUsage_OperatingRegion);
  ...
  sfUpdateLoc(21);
  DeclNewOption_30119F(_apiUsage_LineSearchTask);
  ...
  hamr_SW_UxAS_thr_Impl_Bridge_Api_sendAutomationResponse_(SF hamr_SW_UxAS_thr_Impl_Impl_api_(this), (IS_C4F575) ((IS_C4F575) &t_4));
}
