...
union art_Bridge_EntryPoints {
  ...
  struct hamr_SW_CASE_Filter_ARes_thr_Impl_Bridge_EntryPoints hamr_SW_CASE_Filter_ARes_thr_Impl_Bridge_EntryPoints;
  ...
  struct hamr_SW_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints hamr_SW_CASE_Filter_OR_thr_Impl_Bridge_EntryPoints;
  ...
  struct hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_EntryPoints hamr_SW_CASE_Filter_AReq_thr_Impl_Bridge_EntryPoints;
  ...
  struct hamr_SW_CASE_AttestationManager_thr_Impl_Bridge_EntryPoints hamr_SW_CASE_AttestationManager_thr_Impl_Bridge_EntryPoints;
