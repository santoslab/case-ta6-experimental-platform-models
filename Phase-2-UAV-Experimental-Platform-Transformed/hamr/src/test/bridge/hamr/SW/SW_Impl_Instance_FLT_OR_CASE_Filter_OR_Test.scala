...
class SW_Impl_Instance_FLT_OR_CASE_Filter_OR_Test extends BridgeTestSuite[CASE_Filter_OR_thr_Impl_Bridge](Arch.SW_Impl_Instance_FLT_OR_CASE_Filter_OR) {
  ...
  def getComponent(): CASE_Filter_OR_thr_Impl_Impl = {
    return bridge.entryPoints.asInstanceOf[CASE_Filter_OR_thr_Impl_Bridge.EntryPoints].component
  }
}
