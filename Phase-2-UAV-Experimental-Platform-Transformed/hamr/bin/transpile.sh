...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  ...
  --name "main" \
  --apps "hamr.SW_Impl_Instance_FC_UART_UARTDriver_App,hamr.SW_Impl_Instance_RADIO_RadioDriver_Attestation_App,hamr.SW_Impl_Instance_FlyZones_FlyZonesDatabase_App,hamr.SW_Impl_Instance_UXAS_UxAS_App,hamr.SW_Impl_Instance_WPM_WaypointPlanManagerService_App,hamr.SW_Impl_Instance_AM_CASE_AttestationManager_App,hamr.SW_Impl_Instance_AM_Gate_CASE_AttestationGate_App,hamr.SW_Impl_Instance_FLT_AReq_CASE_Filter_AReq_App,hamr.SW_Impl_Instance_FLT_OR_CASE_Filter_OR_App,hamr.SW_Impl_Instance_FLT_LST_CASE_Filter_LST_App,hamr.SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App,hamr.SW_Impl_Instance_FLT_ARes_CASE_Filter_ARes_App,hamr.SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_App,hamr.Main" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 61 \
  --sequence "MS[Z,art.Bridge]=13;MS[Z,MOption[art.Bridge]]=13;IS[Z,art.UPort]=7;IS[Z,art.UConnection]=23;IS[Z,B]=262144" \
  --constants "art.Art.maxComponents=13;art.Art.maxPorts=61" \
