...
object MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate.entryPoints
  val appPortId: Art.PortId = IPCPorts.MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)
  val trusted_idsPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate.trusted_ids.id
  val trusted_idsPortIdOpt: Option[Art.PortId] = Some(trusted_idsPortId)
  val AutomationRequest_inPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate.AutomationRequest_in.id
  val AutomationRequest_inPortIdOpt: Option[Art.PortId] = Some(AutomationRequest_inPortId)
  val OperatingRegion_inPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate.OperatingRegion_in.id
  val OperatingRegion_inPortIdOpt: Option[Art.PortId] = Some(OperatingRegion_inPortId)
  val LineSearchTask_inPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate.LineSearchTask_in.id
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate_App starting ...")
