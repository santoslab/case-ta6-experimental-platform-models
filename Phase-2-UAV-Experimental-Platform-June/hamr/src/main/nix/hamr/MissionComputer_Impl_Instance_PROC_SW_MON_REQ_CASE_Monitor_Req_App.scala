...
object MissionComputer_Impl_Instance_PROC_SW_MON_REQ_CASE_Monitor_Req_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.MissionComputer_Impl_Instance_PROC_SW_MON_REQ_CASE_Monitor_Req.entryPoints
  val appPortId: Art.PortId = IPCPorts.MissionComputer_Impl_Instance_PROC_SW_MON_REQ_CASE_Monitor_Req_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)
  val observedPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_MON_REQ_CASE_Monitor_Req.observed.id
  val observedPortIdOpt: Option[Art.PortId] = Some(observedPortId)
  val reference_1PortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_MON_REQ_CASE_Monitor_Req.reference_1.id
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("MissionComputer_Impl_Instance_PROC_SW_MON_REQ_CASE_Monitor_Req_App starting ...")
