...
object MissionComputer_Impl_Instance_PROC_SW_WPM_WaypointPlanManagerService_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.MissionComputer_Impl_Instance_PROC_SW_WPM_WaypointPlanManagerService.entryPoints
  val appPortId: Art.PortId = IPCPorts.MissionComputer_Impl_Instance_PROC_SW_WPM_WaypointPlanManagerService_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)
  val AutomationResponsePortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_WPM_WaypointPlanManagerService.AutomationResponse.id
  val AutomationResponsePortIdOpt: Option[Art.PortId] = Some(AutomationResponsePortId)
  val AirVehicleStatePortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_WPM_WaypointPlanManagerService.AirVehicleState.id
  val AirVehicleStatePortIdOpt: Option[Art.PortId] = Some(AirVehicleStatePortId)
  val ReturnHomePortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_WPM_WaypointPlanManagerService.ReturnHome.id
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("MissionComputer_Impl_Instance_PROC_SW_WPM_WaypointPlanManagerService_App starting ...")
