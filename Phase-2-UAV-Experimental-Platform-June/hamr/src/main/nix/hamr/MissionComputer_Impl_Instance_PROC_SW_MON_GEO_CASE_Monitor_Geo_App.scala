...
object MissionComputer_Impl_Instance_PROC_SW_MON_GEO_CASE_Monitor_Geo_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.MissionComputer_Impl_Instance_PROC_SW_MON_GEO_CASE_Monitor_Geo.entryPoints
  val appPortId: Art.PortId = IPCPorts.MissionComputer_Impl_Instance_PROC_SW_MON_GEO_CASE_Monitor_Geo_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)
  val keep_in_zonesPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_MON_GEO_CASE_Monitor_Geo.keep_in_zones.id
  val keep_in_zonesPortIdOpt: Option[Art.PortId] = Some(keep_in_zonesPortId)
  val keep_out_zonesPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_MON_GEO_CASE_Monitor_Geo.keep_out_zones.id
  val keep_out_zonesPortIdOpt: Option[Art.PortId] = Some(keep_out_zonesPortId)
  val observedPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_MON_GEO_CASE_Monitor_Geo.observed.id
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("MissionComputer_Impl_Instance_PROC_SW_MON_GEO_CASE_Monitor_Geo_App starting ...")
