...
object MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS.entryPoints
  val appPortId: Art.PortId = IPCPorts.MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS_App
  val appPortIdOpt: Option[Art.PortId] = Some(appPortId)
  val AutomationRequestPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS.AutomationRequest.id
  val AutomationRequestPortIdOpt: Option[Art.PortId] = Some(AutomationRequestPortId)
  val AirVehicleStatePortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS.AirVehicleState.id
  val AirVehicleStatePortIdOpt: Option[Art.PortId] = Some(AirVehicleStatePortId)
  val OperatingRegionPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS.OperatingRegion.id
  val OperatingRegionPortIdOpt: Option[Art.PortId] = Some(OperatingRegionPortId)
  val LineSearchTaskPortId: Art.PortId = Arch.MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS.LineSearchTask.id
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS_App starting ...")
