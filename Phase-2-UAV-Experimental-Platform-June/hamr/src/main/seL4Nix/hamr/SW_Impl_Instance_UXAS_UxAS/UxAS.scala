...
object UxAS extends App {
  ...
  val UxASBridge : hamr.SW.UxAS_thr_Impl_Bridge = {
    ...
    val AutomationResponse_MON_GEO = Port[Base_Types.Bits] (id = 4, name = "SW_Impl_Instance_UXAS_UxAS_AutomationResponse_MON_GEO", mode = EventOut)
    val AutomationResponse_MON_REQ = Port[Base_Types.Bits] (id = 5, name = "SW_Impl_Instance_UXAS_UxAS_AutomationResponse_MON_REQ", mode = EventOut)
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(AutomationResponse_MON_GEO_port.nonEmpty) {
      UxAS_thr_Impl_seL4Nix.AutomationResponse_MON_GEO_Send(AutomationResponse_MON_GEO_port.get)
      AutomationResponse_MON_GEO_port = noData
    }

    if(AutomationResponse_MON_REQ_port.nonEmpty) {
      UxAS_thr_Impl_seL4Nix.AutomationResponse_MON_REQ_Send(AutomationResponse_MON_REQ_port.get)
