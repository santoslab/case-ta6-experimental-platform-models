...
void atExit(int signum) {
  ...
  StackFrame sf = NULL;
  #endif
  hamr_MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS_App_atExit(SF_LAST);
}
...
int main(int argc, char *argv[]) {
  ...
  DeclNewStackFrame(NULL, "MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS_App.scala", "hamr.MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS_App", "<App>", 0);
  ...
  return (int) hamr_MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS_App_main(SF &t_args);
}