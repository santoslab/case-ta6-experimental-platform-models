...
Unit hamr_SW_RadioDriver_Attestation_thr_Impl_Impl_initialise_(STACK_FRAME hamr_SW_RadioDriver_Attestation_thr_Impl_Impl this) {
  ...
  hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_Api_sendAutomationRequest_(SF hamr_SW_RadioDriver_Attestation_thr_Impl_Impl_api_(this), (IS_C4F575) ((IS_C4F575) &t_1));

  sfUpdateLoc(20);
  DeclNewIS_C4F575(t_2);
  hamr_Base_Types_Bits_empty(SF (IS_C4F575) &t_2);
  hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_Api_sendOperatingRegion_(SF hamr_SW_RadioDriver_Attestation_thr_Impl_Impl_api_(this), (IS_C4F575) ((IS_C4F575) &t_2));

  sfUpdateLoc(21);
  DeclNewIS_C4F575(t_3);
  hamr_Base_Types_Bits_empty(SF (IS_C4F575) &t_3);
  hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_Api_sendLineSearchTask_(SF hamr_SW_RadioDriver_Attestation_thr_Impl_Impl_api_(this), (IS_C4F575) ((IS_C4F575) &t_3));
}
