...
void hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_EntryPoints_apply(STACK_FRAME hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_EntryPoints this, Z RadioDriver_Attestation_thr_Impl_BridgeId, Z trusted_ids_Id, Z AutomationRequest_Id, Z OperatingRegion_Id, Z LineSearchTask_Id, Option_9AF35E dispatchTriggers, hamr_SW_RadioDriver_Attestation_thr_Impl_Impl component) {
  ...
  t_3.size = (int8_t) 3;
  IS_82ABD8_up(&t_3, 0, (Z) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_EntryPoints_AutomationRequest_Id_(this));
  IS_82ABD8_up(&t_3, 1, (Z) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_EntryPoints_OperatingRegion_Id_(this));
  IS_82ABD8_up(&t_3, 2, (Z) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_EntryPoints_LineSearchTask_Id_(this));
