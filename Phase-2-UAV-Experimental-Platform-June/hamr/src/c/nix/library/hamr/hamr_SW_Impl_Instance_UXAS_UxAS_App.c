...
void hamr_SW_Impl_Instance_UXAS_UxAS_App_init(STACK_FRAME_ONLY) {
  ...
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_entryPoints(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_appPortId(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_appPortIdOpt(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_AutomationRequestPortId(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_AutomationRequestPortIdOpt(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_AirVehicleStatePortId(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_AirVehicleStatePortIdOpt(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_OperatingRegionPortId(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_OperatingRegionPortIdOpt(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_LineSearchTaskPortId(SF_LAST);
  hamr_SW_Impl_Instance_UXAS_UxAS_App_init_LineSearchTaskPortIdOpt(SF_LAST);
}
...
Z hamr_SW_Impl_Instance_UXAS_UxAS_App_main(STACK_FRAME IS_948B60 args) {
  ...
  sfUpdateLoc(95);
  {
    ...
    hamr_PlatformNix_receive(SF (Option_882048) hamr_SW_Impl_Instance_UXAS_UxAS_App_appPortIdOpt(SF_LAST), (MBox2_1CBFC4) ((MBox2_1CBFC4) &t_5));
  }
  ...
  sfUpdateLoc(99);
  {
    ...
    hamr_PlatformNix_receive(SF (Option_882048) hamr_SW_Impl_Instance_UXAS_UxAS_App_appPortIdOpt(SF_LAST), (MBox2_1CBFC4) ((MBox2_1CBFC4) &t_6));
  }
  ...
  while(t_106_5) {
    ...
    sfUpdateLoc(108);
    {
      hamr_PlatformNix_receiveAsync(SF (Option_882048) hamr_SW_Impl_Instance_UXAS_UxAS_App_appPortIdOpt(SF_LAST), (MBox2_1029D1) out);
    }
...
static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_44_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1, hamr_Base_Types_Bits_Payload *_v_44_19) {
...
static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_45_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1, art_DataContent *_v_45_19) {
  if (!Some_D29615__is(SF t_1)) return F;
  *_v_45_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_1));
  return T;
}

static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_46_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1) {
  if (!None_964667__is(SF t_1)) return F;
  return T;
}

static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_53_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_6, hamr_Base_Types_Bits_Payload *_v_53_19) {
...
static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_54_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_6, art_DataContent *_v_54_19) {
  if (!Some_D29615__is(SF t_6)) return F;
  *_v_54_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_6));
  return T;
}

static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_55_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_6) {
  if (!None_964667__is(SF t_6)) return F;
  return T;
}

static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_62_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_11, hamr_Base_Types_Bits_Payload *_v_62_19) {
...
static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_63_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_11, art_DataContent *_v_63_19) {
  if (!Some_D29615__is(SF t_11)) return F;
  *_v_63_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_11));
  return T;
}

static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_64_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_11) {
  if (!None_964667__is(SF t_11)) return F;
  return T;
}

static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_71_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_16, hamr_Base_Types_Bits_Payload *_v_71_19) {
...
static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_72_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_16, art_DataContent *_v_72_19) {
  if (!Some_D29615__is(SF t_16)) return F;
  *_v_72_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_16));
  return T;
}

static inline B hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_73_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_16) {
...
Unit hamr_SW_Impl_Instance_UXAS_UxAS_App_compute(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "SW_Impl_Instance_UXAS_UxAS_App.scala", "hamr.SW_Impl_Instance_UXAS_UxAS_App", "compute", 0);
  {
    ...
    sfUpdateLoc(42);
    {
      hamr_PlatformNix_receiveAsync(SF (Option_882048) hamr_SW_Impl_Instance_UXAS_UxAS_App_AutomationRequestPortIdOpt(SF_LAST), (MBox2_1029D1) out);
    }
    ...
    if (!match_43_11) {
      ...
      match_43_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_44_14_8E9F45(SF t_1, &v_44_19);
      if (match_43_11) {

        sfUpdateLoc(44);
        {
          hamr_ArtNix_updateData(SF hamr_SW_Impl_Instance_UXAS_UxAS_App_AutomationRequestPortId(SF_LAST), (art_DataContent) v_44_19);
        }
      }
    }
    if (!match_43_11) {
      art_DataContent v_45_19;
      match_43_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_45_14_8E9F45(SF t_1, &v_45_19);
      if (match_43_11) {
    ...
    if (!match_43_11) {
      match_43_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_46_14_8E9F45(SF t_1);
      if (match_43_11) {
      }
    }
  ...
  }
  {
    ...
    sfUpdateLoc(51);
    {
      hamr_PlatformNix_receiveAsync(SF (Option_882048) hamr_SW_Impl_Instance_UXAS_UxAS_App_AirVehicleStatePortIdOpt(SF_LAST), (MBox2_1029D1) out);
    }
    ...
    if (!match_52_11) {
      ...
      match_52_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_53_14_8E9F45(SF t_6, &v_53_19);
      if (match_52_11) {

        sfUpdateLoc(53);
        {
          hamr_ArtNix_updateData(SF hamr_SW_Impl_Instance_UXAS_UxAS_App_AirVehicleStatePortId(SF_LAST), (art_DataContent) v_53_19);
        }
      }
    }
    if (!match_52_11) {
      art_DataContent v_54_19;
      match_52_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_54_14_8E9F45(SF t_6, &v_54_19);
      if (match_52_11) {
    ...
    if (!match_52_11) {
      match_52_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_55_14_8E9F45(SF t_6);
      if (match_52_11) {
      }
    }
  ...
  }
  {
    ...
    sfUpdateLoc(60);
    {
      hamr_PlatformNix_receiveAsync(SF (Option_882048) hamr_SW_Impl_Instance_UXAS_UxAS_App_OperatingRegionPortIdOpt(SF_LAST), (MBox2_1029D1) out);
    }
    ...
    if (!match_61_11) {
      ...
      match_61_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_62_14_8E9F45(SF t_11, &v_62_19);
      if (match_61_11) {

        sfUpdateLoc(62);
        {
          hamr_ArtNix_updateData(SF hamr_SW_Impl_Instance_UXAS_UxAS_App_OperatingRegionPortId(SF_LAST), (art_DataContent) v_62_19);
        }
      }
    }
    if (!match_61_11) {
      art_DataContent v_63_19;
      match_61_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_63_14_8E9F45(SF t_11, &v_63_19);
      if (match_61_11) {
    ...
    if (!match_61_11) {
      match_61_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_64_14_8E9F45(SF t_11);
      if (match_61_11) {
      }
    }
  ...
  }
  {
    ...
    sfUpdateLoc(69);
    {
      hamr_PlatformNix_receiveAsync(SF (Option_882048) hamr_SW_Impl_Instance_UXAS_UxAS_App_LineSearchTaskPortIdOpt(SF_LAST), (MBox2_1029D1) out);
    }
    ...
    if (!match_70_11) {
      ...
      match_70_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_71_14_8E9F45(SF t_16, &v_71_19);
      if (match_70_11) {

        sfUpdateLoc(71);
        {
          hamr_ArtNix_updateData(SF hamr_SW_Impl_Instance_UXAS_UxAS_App_LineSearchTaskPortId(SF_LAST), (art_DataContent) v_71_19);
        }
      }
    }
    if (!match_70_11) {
      art_DataContent v_72_19;
      match_70_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_72_14_8E9F45(SF t_16, &v_72_19);
      if (match_70_11) {
    ...
    if (!match_70_11) {
      match_70_11 = hamr_SW_Impl_Instance_UXAS_UxAS_App_compute_extract_73_14_8E9F45(SF t_16);
      if (match_70_11) {
      }
    }
