...
static inline B hamr_ArtNix_sendOutput_extract_141_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, art_DataContent *_d_141_19) {
  if (!Some_D29615__is(SF t_0)) return F;
  *_d_141_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_0));
  return T;
}

static inline B hamr_ArtNix_sendOutput_extract_146_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0) {
  return T;
}

static inline B hamr_ArtNix_sendOutput_extract_152_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_8, art_DataContent *_d_152_19) {
  if (!Some_D29615__is(SF t_8)) return F;
  *_d_152_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_8));
  return T;
}

static inline B hamr_ArtNix_sendOutput_extract_157_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_8) {
  return T;
}
...
Unit hamr_ArtNix_sendOutput(STACK_FRAME IS_82ABD8 eventPortIds, IS_82ABD8 dataPortIds) {
  ...
  sfUpdateLoc(139);
  {
    ...
    for (int8_t t_7 = 0; t_7 < t_6; t_7++) {
      ...
      B match_140_7 = F;
      if (!match_140_7) {
        art_DataContent d_141_19;
        match_140_7 = hamr_ArtNix_sendOutput_extract_141_14_8E9F45(SF ((Option_8E9F45) &t_0), &d_141_19);
        if (match_140_7) {
          ...
          sfUpdateLoc(143);
          {
            ...
            for (int8_t t_4 = 0; t_4 < t_3; t_4++) {
              ...
              sfUpdateLoc(144);
              {
                B t_1 = hamr_PlatformNix_sendAsync(SF Tuple2_EC3B57_1(e), Tuple2_EC3B57_2(e), (art_DataContent) d_141_19);
              }
            }
          }
        }
      ...
      if (!match_140_7) {
        match_140_7 = hamr_ArtNix_sendOutput_extract_146_14_8E9F45(SF ((Option_8E9F45) &t_0));
        if (match_140_7) {
        }
      }
      sfAssert(match_140_7, "Error when pattern matching.");
    }
  }
  ...
  sfUpdateLoc(150);
  {
    ...
    for (int8_t t_15 = 0; t_15 < t_14; t_15++) {
      ...
      B match_151_7 = F;
      if (!match_151_7) {
        art_DataContent d_152_19;
        match_151_7 = hamr_ArtNix_sendOutput_extract_152_14_8E9F45(SF ((Option_8E9F45) &t_8), &d_152_19);
        if (match_151_7) {
          ...
          sfUpdateLoc(154);
          {
            ...
            for (int8_t t_12 = 0; t_12 < t_11; t_12++) {
              ...
              sfUpdateLoc(155);
              {
                B t_9 = hamr_PlatformNix_sendAsync(SF Tuple2_EC3B57_1(e), Tuple2_EC3B57_2(e), (art_DataContent) d_152_19);
              }
            }
          }
        }
      ...
      if (!match_151_7) {
        match_151_7 = hamr_ArtNix_sendOutput_extract_157_14_8E9F45(SF ((Option_8E9F45) &t_8));
        if (match_151_7) {
        }
      }
      sfAssert(match_151_7, "Error when pattern matching.");
    }
  }
}
...
void hamr_ArtNix_init_connection(STACK_FRAME_ONLY) {
  ...
  sfUpdateLoc(16);
  {
    ...
    sfUpdateLoc(19);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_5, hamr_IPCPorts_SW_Impl_Instance_WPM_WaypointPlanManagerService_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_WaypointPlanManagerService_thr_Impl_Bridge_AirVehicleState_(hamr_Arch_SW_Impl_Instance_WPM_WaypointPlanManagerService(SF_LAST))));
      IS_AA0F82_up(&t_4, 0, (Tuple2_EC3B57) (&t_5));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_AirVehicleState_WPM_(hamr_Arch_SW_Impl_Instance_FC_UART_UARTDriver(SF_LAST))), (IS_AA0F82) (&t_4));
    }
    ...
    sfUpdateLoc(22);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_7, hamr_IPCPorts_SW_Impl_Instance_UXAS_UxAS_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_UxAS_thr_Impl_Bridge_AirVehicleState_(hamr_Arch_SW_Impl_Instance_UXAS_UxAS(SF_LAST))));
      IS_AA0F82_up(&t_6, 0, (Tuple2_EC3B57) (&t_7));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_AirVehicleState_UXAS_(hamr_Arch_SW_Impl_Instance_FC_UART_UARTDriver(SF_LAST))), (IS_AA0F82) (&t_6));
    }
    ...
    sfUpdateLoc(25);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_9, hamr_IPCPorts_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_trusted_ids_(hamr_Arch_SW_Impl_Instance_AM_Gate_CASE_AttestationGate(SF_LAST))));
      IS_AA0F82_up(&t_8, 0, (Tuple2_EC3B57) (&t_9));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_trusted_ids_(hamr_Arch_SW_Impl_Instance_RADIO_RadioDriver_Attestation(SF_LAST))), (IS_AA0F82) (&t_8));
    }
    ...
    sfUpdateLoc(28);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_11, hamr_IPCPorts_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_in_(hamr_Arch_SW_Impl_Instance_AM_Gate_CASE_AttestationGate(SF_LAST))));
      IS_AA0F82_up(&t_10, 0, (Tuple2_EC3B57) (&t_11));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_AutomationRequest_(hamr_Arch_SW_Impl_Instance_RADIO_RadioDriver_Attestation(SF_LAST))), (IS_AA0F82) (&t_10));
    }
    ...
    sfUpdateLoc(31);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_13, hamr_IPCPorts_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_in_(hamr_Arch_SW_Impl_Instance_AM_Gate_CASE_AttestationGate(SF_LAST))));
      IS_AA0F82_up(&t_12, 0, (Tuple2_EC3B57) (&t_13));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_OperatingRegion_(hamr_Arch_SW_Impl_Instance_RADIO_RadioDriver_Attestation(SF_LAST))), (IS_AA0F82) (&t_12));
    }
    ...
    sfUpdateLoc(34);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_15, hamr_IPCPorts_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_in_(hamr_Arch_SW_Impl_Instance_AM_Gate_CASE_AttestationGate(SF_LAST))));
      IS_AA0F82_up(&t_14, 0, (Tuple2_EC3B57) (&t_15));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_LineSearchTask_(hamr_Arch_SW_Impl_Instance_RADIO_RadioDriver_Attestation(SF_LAST))), (IS_AA0F82) (&t_14));
    }
    ...
    sfUpdateLoc(37);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_17, hamr_IPCPorts_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge_keep_in_zones_(hamr_Arch_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo(SF_LAST))));
      IS_AA0F82_up(&t_16, 0, (Tuple2_EC3B57) (&t_17));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_FlyZonesDatabase_thr_Impl_Bridge_keep_in_zones_(hamr_Arch_SW_Impl_Instance_FlyZones_FlyZonesDatabase(SF_LAST))), (IS_AA0F82) (&t_16));
    }
    ...
    sfUpdateLoc(40);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_19, hamr_IPCPorts_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge_keep_out_zones_(hamr_Arch_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo(SF_LAST))));
      IS_AA0F82_up(&t_18, 0, (Tuple2_EC3B57) (&t_19));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_FlyZonesDatabase_thr_Impl_Bridge_keep_out_zones_(hamr_Arch_SW_Impl_Instance_FlyZones_FlyZonesDatabase(SF_LAST))), (IS_AA0F82) (&t_18));
    }
    ...
    sfUpdateLoc(43);
    {
      ...
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_UxAS_thr_Impl_Bridge_AutomationResponse_MON_GEO_(hamr_Arch_SW_Impl_Instance_UXAS_UxAS(SF_LAST))), (IS_AA0F82) (&t_20));
    }
    ...
    sfUpdateLoc(46);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_23, hamr_IPCPorts_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_observed_(hamr_Arch_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req(SF_LAST))));
      IS_AA0F82_up(&t_22, 0, (Tuple2_EC3B57) (&t_23));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_UxAS_thr_Impl_Bridge_AutomationResponse_MON_REQ_(hamr_Arch_SW_Impl_Instance_UXAS_UxAS(SF_LAST))), (IS_AA0F82) (&t_22));
    }
    ...
    sfUpdateLoc(49);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_25, hamr_IPCPorts_SW_Impl_Instance_FC_UART_UARTDriver_App(SF_LAST), art_Port_45E54D_id_(hamr_Drivers_UARTDriver_Impl_Bridge_MissionCommand_(hamr_Arch_SW_Impl_Instance_FC_UART_UARTDriver(SF_LAST))));
      IS_AA0F82_up(&t_24, 0, (Tuple2_EC3B57) (&t_25));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_WaypointPlanManagerService_thr_Impl_Bridge_MissionCommand_(hamr_Arch_SW_Impl_Instance_WPM_WaypointPlanManagerService(SF_LAST))), (IS_AA0F82) (&t_24));
    }
    ...
    sfUpdateLoc(52);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_27, hamr_IPCPorts_SW_Impl_Instance_UXAS_UxAS_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_UxAS_thr_Impl_Bridge_AutomationRequest_(hamr_Arch_SW_Impl_Instance_UXAS_UxAS(SF_LAST))));
      IS_AA0F82_up(&t_26, 0, (Tuple2_EC3B57) (&t_27));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_UXAS_(hamr_Arch_SW_Impl_Instance_AM_Gate_CASE_AttestationGate(SF_LAST))), (IS_AA0F82) (&t_26));
    }
    ...
    sfUpdateLoc(55);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_29, hamr_IPCPorts_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_CASE_Monitor_Req_thr_Impl_Bridge_reference_1_(hamr_Arch_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req(SF_LAST))));
      IS_AA0F82_up(&t_28, 0, (Tuple2_EC3B57) (&t_29));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_MON_REQ_(hamr_Arch_SW_Impl_Instance_AM_Gate_CASE_AttestationGate(SF_LAST))), (IS_AA0F82) (&t_28));
    }
    ...
    sfUpdateLoc(58);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_31, hamr_IPCPorts_SW_Impl_Instance_UXAS_UxAS_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_UxAS_thr_Impl_Bridge_OperatingRegion_(hamr_Arch_SW_Impl_Instance_UXAS_UxAS(SF_LAST))));
    ...
    sfUpdateLoc(64);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_35, hamr_IPCPorts_SW_Impl_Instance_UXAS_UxAS_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_UxAS_thr_Impl_Bridge_LineSearchTask_(hamr_Arch_SW_Impl_Instance_UXAS_UxAS(SF_LAST))));
      IS_AA0F82_up(&t_34, 0, (Tuple2_EC3B57) (&t_35));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_CASE_Filter_LST_thr_Impl_Bridge_filter_out_(hamr_Arch_SW_Impl_Instance_FLT_LST_CASE_Filter_LST(SF_LAST))), (IS_AA0F82) (&t_34));
    }
    ...
    sfUpdateLoc(67);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_37, hamr_IPCPorts_SW_Impl_Instance_WPM_WaypointPlanManagerService_App(SF_LAST), art_Port_45E54D_id_(hamr_SW_WaypointPlanManagerService_thr_Impl_Bridge_AutomationResponse_(hamr_Arch_SW_Impl_Instance_WPM_WaypointPlanManagerService(SF_LAST))));
      IS_AA0F82_up(&t_36, 0, (Tuple2_EC3B57) (&t_37));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge_output_(hamr_Arch_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo(SF_LAST))), (IS_AA0F82) (&t_36));
    }
    ...
    sfUpdateLoc(70);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_39, hamr_IPCPorts_SW_Impl_Instance_WPM_WaypointPlanManagerService_App(SF_LAST), art_Port_9CBF18_id_(hamr_SW_WaypointPlanManagerService_thr_Impl_Bridge_ReturnHome_(hamr_Arch_SW_Impl_Instance_WPM_WaypointPlanManagerService(SF_LAST))));
      IS_AA0F82_up(&t_38, 0, (Tuple2_EC3B57) (&t_39));
      MS_B5E3E6_up(r, art_Port_9CBF18_id_(hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge_alert_(hamr_Arch_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo(SF_LAST))), (IS_AA0F82) (&t_38));
    }
