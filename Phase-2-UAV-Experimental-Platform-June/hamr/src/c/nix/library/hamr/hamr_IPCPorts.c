...
void hamr_IPCPorts_init(STACK_FRAME_ONLY) {
  ...
  hamr_IPCPorts_init_SW_Impl_Instance_FC_UART_UARTDriver_App(SF_LAST);
  hamr_IPCPorts_init_SW_Impl_Instance_RADIO_RadioDriver_Attestation_App(SF_LAST);
  hamr_IPCPorts_init_SW_Impl_Instance_FlyZones_FlyZonesDatabase_App(SF_LAST);
  hamr_IPCPorts_init_SW_Impl_Instance_UXAS_UxAS_App(SF_LAST);
  hamr_IPCPorts_init_SW_Impl_Instance_WPM_WaypointPlanManagerService_App(SF_LAST);
  hamr_IPCPorts_init_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_App(SF_LAST);
  hamr_IPCPorts_init_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_App(SF_LAST);
  hamr_IPCPorts_init_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App(SF_LAST);
  hamr_IPCPorts_init_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_App(SF_LAST);
...
void hamr_IPCPorts_init_SW_Impl_Instance_FC_UART_UARTDriver_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(11);
  _hamr_IPCPorts_SW_Impl_Instance_FC_UART_UARTDriver_App = Z_C(41);
};
...
void hamr_IPCPorts_init_SW_Impl_Instance_RADIO_RadioDriver_Attestation_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(12);
  _hamr_IPCPorts_SW_Impl_Instance_RADIO_RadioDriver_Attestation_App = Z_C(42);
};
...
void hamr_IPCPorts_init_SW_Impl_Instance_FlyZones_FlyZonesDatabase_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(13);
  _hamr_IPCPorts_SW_Impl_Instance_FlyZones_FlyZonesDatabase_App = Z_C(43);
};
...
void hamr_IPCPorts_init_SW_Impl_Instance_UXAS_UxAS_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(14);
  _hamr_IPCPorts_SW_Impl_Instance_UXAS_UxAS_App = Z_C(44);
};
...
void hamr_IPCPorts_init_SW_Impl_Instance_WPM_WaypointPlanManagerService_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(15);
  _hamr_IPCPorts_SW_Impl_Instance_WPM_WaypointPlanManagerService_App = Z_C(45);
};
...
void hamr_IPCPorts_init_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(16);
  _hamr_IPCPorts_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_App = Z_C(46);
};
...
void hamr_IPCPorts_init_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(17);
  _hamr_IPCPorts_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_App = Z_C(47);
};
...
void hamr_IPCPorts_init_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(18);
  _hamr_IPCPorts_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_App = Z_C(48);
};
...
void hamr_IPCPorts_init_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(19);
  _hamr_IPCPorts_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_App = Z_C(49);
};
