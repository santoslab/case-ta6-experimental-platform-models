...
void hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_init(STACK_FRAME_ONLY) {
  ...
  hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_init_entryPoints(SF_LAST);
  hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_init_appPortId(SF_LAST);
  hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_init_appPortIdOpt(SF_LAST);
  hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_init_recv_dataPortId(SF_LAST);
  hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_init_recv_dataPortIdOpt(SF_LAST);
  hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_init_MissionCommandPortId(SF_LAST);
  hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_init_MissionCommandPortIdOpt(SF_LAST);
}
...
Z hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_main(STACK_FRAME IS_948B60 args) {
  ...
  sfUpdateLoc(71);
  {
    ...
    hamr_PlatformNix_receive(SF (Option_882048) hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_appPortIdOpt(SF_LAST), (MBox2_1CBFC4) ((MBox2_1CBFC4) &t_5));
  }
  ...
  sfUpdateLoc(75);
  {
    ...
    hamr_PlatformNix_receive(SF (Option_882048) hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_appPortIdOpt(SF_LAST), (MBox2_1CBFC4) ((MBox2_1CBFC4) &t_6));
  }
  ...
  while(t_82_5) {
    ...
    sfUpdateLoc(84);
    {
      hamr_PlatformNix_receiveAsync(SF (Option_882048) hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_appPortIdOpt(SF_LAST), (MBox2_1029D1) out);
    }
...
static inline B hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_38_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1, hamr_Base_Types_Bits_Payload *_v_38_19) {
...
static inline B hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_39_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1, art_DataContent *_v_39_19) {
  if (!Some_D29615__is(SF t_1)) return F;
  *_v_39_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_1));
  return T;
}

static inline B hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_40_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1) {
  if (!None_964667__is(SF t_1)) return F;
  return T;
}

static inline B hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_47_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_6, hamr_Base_Types_Bits_Payload *_v_47_19) {
...
static inline B hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_48_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_6, art_DataContent *_v_48_19) {
  if (!Some_D29615__is(SF t_6)) return F;
  *_v_48_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_6));
  return T;
}

static inline B hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_49_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_6) {
...
Unit hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "SW_Impl_Instance_FC_UART_UARTDriver_App.scala", "hamr.SW_Impl_Instance_FC_UART_UARTDriver_App", "compute", 0);
  {
    ...
    sfUpdateLoc(36);
    {
      hamr_PlatformNix_receiveAsync(SF (Option_882048) hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_recv_dataPortIdOpt(SF_LAST), (MBox2_1029D1) out);
    }
    ...
    if (!match_37_11) {
      ...
      match_37_11 = hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_38_14_8E9F45(SF t_1, &v_38_19);
      if (match_37_11) {

        sfUpdateLoc(38);
        {
          hamr_ArtNix_updateData(SF hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_recv_dataPortId(SF_LAST), (art_DataContent) v_38_19);
        }
      }
    }
    if (!match_37_11) {
      art_DataContent v_39_19;
      match_37_11 = hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_39_14_8E9F45(SF t_1, &v_39_19);
      if (match_37_11) {
    ...
    if (!match_37_11) {
      match_37_11 = hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_40_14_8E9F45(SF t_1);
      if (match_37_11) {
      }
    }
  ...
  }
  {
    ...
    sfUpdateLoc(45);
    {
      hamr_PlatformNix_receiveAsync(SF (Option_882048) hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_MissionCommandPortIdOpt(SF_LAST), (MBox2_1029D1) out);
    }
    ...
    if (!match_46_11) {
      ...
      match_46_11 = hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_47_14_8E9F45(SF t_6, &v_47_19);
      if (match_46_11) {

        sfUpdateLoc(47);
        {
          hamr_ArtNix_updateData(SF hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_MissionCommandPortId(SF_LAST), (art_DataContent) v_47_19);
        }
      }
    }
    if (!match_46_11) {
      art_DataContent v_48_19;
      match_46_11 = hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_48_14_8E9F45(SF t_6, &v_48_19);
      if (match_46_11) {
    ...
    if (!match_46_11) {
      match_46_11 = hamr_SW_Impl_Instance_FC_UART_UARTDriver_App_compute_extract_49_14_8E9F45(SF t_6);
      if (match_46_11) {
      }
    }
