...
class MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS_Test extends BridgeTestSuite[UxAS_thr_Impl_Bridge](Arch.MissionComputer_Impl_Instance_PROC_SW_UXAS_UxAS) {
