...
class MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate_Test extends BridgeTestSuite[CASE_AttestationGate_thr_Impl_Bridge](Arch.MissionComputer_Impl_Instance_PROC_SW_AM_Gate_CASE_AttestationGate) {
