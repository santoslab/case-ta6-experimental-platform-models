...
class MissionComputer_Impl_Instance_PROC_SW_MON_GEO_CASE_Monitor_Geo_Test extends BridgeTestSuite[CASE_Monitor_Geo_thr_Impl_Bridge](Arch.MissionComputer_Impl_Instance_PROC_SW_MON_GEO_CASE_Monitor_Geo) {
