...
class SW_Impl_Instance_AM_Gate_CASE_AttestationGate_Test extends BridgeTestSuite[CASE_AttestationGate_thr_Impl_Bridge](Arch.SW_Impl_Instance_AM_Gate_CASE_AttestationGate) {
  ...
  def get_AutomationRequest_UXAS(): Option[Base_Types.Bits] = {
    val value: Option[Base_Types.Bits] = get_AutomationRequest_UXAS_payload() match {
      case Some(Base_Types.Bits_Payload(v)) => Some(v)
      case Some(v) => fail(s"Unexpected payload on port AutomationRequest_UXAS.  Expecting 'Base_Types.Bits_Payload' but received ${v}")
  ...
  def get_AutomationRequest_UXAS_payload(): Option[Base_Types.Bits_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.AutomationRequest_UXAS_Id).asInstanceOf[Option[Base_Types.Bits_Payload]]
  }

  // getter for out EventDataPort
  def get_AutomationRequest_MON_REQ(): Option[Base_Types.Bits] = {
    val value: Option[Base_Types.Bits] = get_AutomationRequest_MON_REQ_payload() match {
      case Some(Base_Types.Bits_Payload(v)) => Some(v)
      case Some(v) => fail(s"Unexpected payload on port AutomationRequest_MON_REQ.  Expecting 'Base_Types.Bits_Payload' but received ${v}")
      case _ => None[Base_Types.Bits]()
    }
    return value
  }
  ...
  // payload getter for out EventDataPort
  def get_AutomationRequest_MON_REQ_payload(): Option[Base_Types.Bits_Payload] = {
    return ArtNative_Ext.observeOutPortValue(bridge.api.AutomationRequest_MON_REQ_Id).asInstanceOf[Option[Base_Types.Bits_Payload]]
  }
