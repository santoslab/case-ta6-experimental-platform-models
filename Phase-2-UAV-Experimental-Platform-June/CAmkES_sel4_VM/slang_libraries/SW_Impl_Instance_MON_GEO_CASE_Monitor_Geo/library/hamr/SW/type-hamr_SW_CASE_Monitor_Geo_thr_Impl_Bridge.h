#ifndef SIREUM_TYPE_H_hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge
#define SIREUM_TYPE_H_hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge
...
typedef struct hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge *hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge;
struct hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge {
  TYPE type;
...
#define DeclNewhamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge(x) struct hamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge x = { .type = Thamr_SW_CASE_Monitor_Geo_thr_Impl_Bridge }
