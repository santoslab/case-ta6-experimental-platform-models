...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "CASE_Monitor_Geo.scala", "hamr.SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo.CASE_Monitor_Geo", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_MON_GEO_CASE_Monitor_Geo_CASE_Monitor_Geo_main(SF &t_args);
}