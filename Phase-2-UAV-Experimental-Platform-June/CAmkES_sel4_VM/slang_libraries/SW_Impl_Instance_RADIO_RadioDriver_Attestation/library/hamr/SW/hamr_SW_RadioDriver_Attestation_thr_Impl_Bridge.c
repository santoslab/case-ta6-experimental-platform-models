...
void hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_apply(STACK_FRAME hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge this, Z id, String name, art_DispatchPropertyProtocol dispatchProtocol, Option_9AF35E dispatchTriggers, art_Port_45E54D trusted_ids, art_Port_45E54D recv_data, art_Port_45E54D send_data, art_Port_45E54D AutomationRequest, art_Port_45E54D OperatingRegion, art_Port_45E54D LineSearchTask) {
  ...
  Type_assign(&this->LineSearchTask, LineSearchTask, sizeof(struct art_Port_45E54D));
  {
    ...
    t_1.size = (int8_t) 6;
    IS_820232_up(&t_1, 0, (art_UPort) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_trusted_ids_(this));
    IS_820232_up(&t_1, 1, (art_UPort) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_recv_data_(this));
    IS_820232_up(&t_1, 2, (art_UPort) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_send_data_(this));
    IS_820232_up(&t_1, 3, (art_UPort) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_AutomationRequest_(this));
    IS_820232_up(&t_1, 4, (art_UPort) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_OperatingRegion_(this));
    IS_820232_up(&t_1, 5, (art_UPort) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_LineSearchTask_(this));
    ...
    t_3.size = (int8_t) 1;
    IS_820232_up(&t_3, 0, (art_UPort) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_trusted_ids_(this));
    STATIC_ASSERT(1 <= MaxIS_820232, "Insufficient maximum for IS[Z, art.UPort] elements.");
  ...
  }
  {
    ...
    hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_Api_apply(SF &t_6, hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_id_(this), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_trusted_ids_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_recv_data_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_send_data_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_AutomationRequest_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_OperatingRegion_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_LineSearchTask_(this)));
  ...
  }
  {
    ...
    hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_EntryPoints_apply(SF &t_7, hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_id_(this), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_trusted_ids_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_recv_data_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_send_data_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_AutomationRequest_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_OperatingRegion_(this)), art_Port_45E54D_id_(hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_LineSearchTask_(this)), (Option_9AF35E) hamr_SW_RadioDriver_Attestation_thr_Impl_Bridge_dispatchTriggers_(this), (hamr_SW_RadioDriver_Attestation_thr_Impl_Impl) (&t_8));
