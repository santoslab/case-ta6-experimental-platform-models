...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "RadioDriver_Attestation.scala", "hamr.SW_Impl_Instance_RADIO_RadioDriver_Attestation.RadioDriver_Attestation", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_RADIO_RadioDriver_Attestation_RadioDriver_Attestation_main(SF &t_args);
}