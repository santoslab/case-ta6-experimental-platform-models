...
#include <type-hamr_SW_RadioDriver_Attestation_thr_Impl_seL4Nix.h>
#include <type-hamr_SW_Impl_Instance_RADIO_RadioDriver_Attestation_RadioDriver_Attestation.h>
