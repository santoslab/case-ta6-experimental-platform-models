...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "FlyZonesDatabase.scala", "hamr.SW_Impl_Instance_FlyZones_FlyZonesDatabase.FlyZonesDatabase", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_FlyZones_FlyZonesDatabase_FlyZonesDatabase_main(SF &t_args);
}