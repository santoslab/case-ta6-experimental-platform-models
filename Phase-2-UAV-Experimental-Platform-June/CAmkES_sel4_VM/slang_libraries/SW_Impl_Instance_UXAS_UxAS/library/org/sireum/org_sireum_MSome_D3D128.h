...
inline B MSome_D3D128__ne(MSome_D3D128 this, MSome_D3D128 other) {
...
inline B MSome_D3D128__is(STACK_FRAME void* this) {
  return ((MSome_D3D128) this)->type == TMSome_D3D128;
}

inline MSome_D3D128 MSome_D3D128__as(STACK_FRAME void *this) {
  if (MSome_D3D128__is(CALLER this)) return (MSome_D3D128) this;
  fprintf(stderr, "Invalid case from %s to MSome[art.Bridge].", TYPE_string_(this));
  sfAbortImpl(CALLER "");
  abort();
}
