...
#define hamr_SW_UxAS_thr_Impl_Bridge_EntryPoints_AutomationResponse_MON_GEO_Id_(this) ((this)->AutomationResponse_MON_GEO_Id)
#define hamr_SW_UxAS_thr_Impl_Bridge_EntryPoints_AutomationResponse_MON_REQ_Id_(this) ((this)->AutomationResponse_MON_REQ_Id)
...
void hamr_SW_UxAS_thr_Impl_Bridge_EntryPoints_apply(STACK_FRAME hamr_SW_UxAS_thr_Impl_Bridge_EntryPoints this, Z UxAS_thr_Impl_BridgeId, Z AutomationRequest_Id, Z AirVehicleState_Id, Z OperatingRegion_Id, Z LineSearchTask_Id, Z AutomationResponse_MON_GEO_Id, Z AutomationResponse_MON_REQ_Id, Option_9AF35E dispatchTriggers, hamr_SW_UxAS_thr_Impl_Impl component);
