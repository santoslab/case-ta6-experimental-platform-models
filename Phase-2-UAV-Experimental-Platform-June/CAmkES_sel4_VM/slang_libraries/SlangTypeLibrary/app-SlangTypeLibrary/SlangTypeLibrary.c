...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "SlangTypeLibrary.scala", "hamr.SlangTypeLibrary.SlangTypeLibrary", "<App>", 0);
  ...
  return (int) hamr_SlangTypeLibrary_SlangTypeLibrary_main(SF &t_args);
}