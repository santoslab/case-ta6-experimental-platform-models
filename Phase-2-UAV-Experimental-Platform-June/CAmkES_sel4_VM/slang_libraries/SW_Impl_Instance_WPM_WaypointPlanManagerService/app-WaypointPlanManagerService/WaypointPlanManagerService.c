...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "WaypointPlanManagerService.scala", "hamr.SW_Impl_Instance_WPM_WaypointPlanManagerService.WaypointPlanManagerService", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService_main(SF &t_args);
}