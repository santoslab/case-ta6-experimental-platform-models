...
#include <hamr_SW_WaypointPlanManagerService_thr_Impl_seL4Nix.h>
#include <hamr_SW_Impl_Instance_WPM_WaypointPlanManagerService_WaypointPlanManagerService.h>
