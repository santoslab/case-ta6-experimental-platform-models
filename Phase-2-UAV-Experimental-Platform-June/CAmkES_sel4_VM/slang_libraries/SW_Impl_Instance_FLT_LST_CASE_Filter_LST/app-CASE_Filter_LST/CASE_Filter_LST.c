...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "CASE_Filter_LST.scala", "hamr.SW_Impl_Instance_FLT_LST_CASE_Filter_LST.CASE_Filter_LST", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_FLT_LST_CASE_Filter_LST_CASE_Filter_LST_main(SF &t_args);
}