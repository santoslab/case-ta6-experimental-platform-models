...
void hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints_apply(STACK_FRAME hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints this, Z CASE_AttestationGate_thr_Impl_BridgeId, Z trusted_ids_Id, Z AutomationRequest_in_Id, Z AutomationRequest_UXAS_Id, Z AutomationRequest_MON_REQ_Id, Z OperatingRegion_in_Id, Z OperatingRegion_out_Id, Z LineSearchTask_in_Id, Z LineSearchTask_out_Id, Option_9AF35E dispatchTriggers, hamr_SW_CASE_AttestationGate_thr_Impl_Impl component) {
  ...
  }
  {
    ...
    t_3.size = (int16_t) 4;
    IS_82ABD8_up(&t_3, 0, (Z) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints_AutomationRequest_UXAS_Id_(this));
    IS_82ABD8_up(&t_3, 1, (Z) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints_AutomationRequest_MON_REQ_Id_(this));
    IS_82ABD8_up(&t_3, 2, (Z) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints_OperatingRegion_out_Id_(this));
    IS_82ABD8_up(&t_3, 3, (Z) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints_LineSearchTask_out_Id_(this));
