...
B hamr_SW_CASE_AttestationGate_thr_Impl_Bridge__eq(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge this, hamr_SW_CASE_AttestationGate_thr_Impl_Bridge other) {
  ...
  if (art_Port_45E54D__ne((art_Port_45E54D) &this->AutomationRequest_UXAS, (art_Port_45E54D) &other->AutomationRequest_UXAS)) return F;
  if (art_Port_45E54D__ne((art_Port_45E54D) &this->AutomationRequest_MON_REQ, (art_Port_45E54D) &other->AutomationRequest_MON_REQ)) return F;
...
void hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_string_(STACK_FRAME String result, hamr_SW_CASE_AttestationGate_thr_Impl_Bridge this) {
  ...
  String_string_(SF result, sep);
  art_Port_45E54D_string_(SF result, (art_Port_45E54D) &this->AutomationRequest_UXAS);
  String_string_(SF result, sep);
  art_Port_45E54D_string_(SF result, (art_Port_45E54D) &this->AutomationRequest_MON_REQ);
  String_string_(SF result, sep);
...
void hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_cprint(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge this, B isOut) {
  ...
  String_cprint(sep, isOut);
  art_Port_45E54D_cprint((art_Port_45E54D) &this->AutomationRequest_UXAS, isOut);
  String_cprint(sep, isOut);
  art_Port_45E54D_cprint((art_Port_45E54D) &this->AutomationRequest_MON_REQ, isOut);
  String_cprint(sep, isOut);
...
void hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_apply(STACK_FRAME hamr_SW_CASE_AttestationGate_thr_Impl_Bridge this, Z id, String name, art_DispatchPropertyProtocol dispatchProtocol, Option_9AF35E dispatchTriggers, art_Port_45E54D trusted_ids, art_Port_45E54D AutomationRequest_in, art_Port_45E54D AutomationRequest_UXAS, art_Port_45E54D AutomationRequest_MON_REQ, art_Port_45E54D OperatingRegion_in, art_Port_45E54D OperatingRegion_out, art_Port_45E54D LineSearchTask_in, art_Port_45E54D LineSearchTask_out) {
  ...
  Type_assign(&this->AutomationRequest_UXAS, AutomationRequest_UXAS, sizeof(struct art_Port_45E54D));
  Type_assign(&this->AutomationRequest_MON_REQ, AutomationRequest_MON_REQ, sizeof(struct art_Port_45E54D));
  ...
  Type_assign(&this->LineSearchTask_out, LineSearchTask_out, sizeof(struct art_Port_45E54D));
  {
    ...
    IS_820232_up(&t_1, 2, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_UXAS_(this));
    IS_820232_up(&t_1, 3, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_MON_REQ_(this));
    IS_820232_up(&t_1, 4, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_in_(this));
    IS_820232_up(&t_1, 5, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_out_(this));
    IS_820232_up(&t_1, 6, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_in_(this));
    IS_820232_up(&t_1, 7, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_out_(this));
    ...
    t_5.size = (int8_t) 4;
    IS_820232_up(&t_5, 0, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_UXAS_(this));
    IS_820232_up(&t_5, 1, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_MON_REQ_(this));
    IS_820232_up(&t_5, 2, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_out_(this));
    IS_820232_up(&t_5, 3, (art_UPort) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_out_(this));
  ...
  }
  {
    ...
    hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_Api_apply(SF &t_6, hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_id_(this), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_trusted_ids_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_in_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_UXAS_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_MON_REQ_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_in_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_out_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_in_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_out_(this)));
  ...
  }
  {
    ...
    hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_EntryPoints_apply(SF &t_7, hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_id_(this), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_trusted_ids_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_in_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_UXAS_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_AutomationRequest_MON_REQ_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_in_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_OperatingRegion_out_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_in_(this)), art_Port_45E54D_id_(hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_LineSearchTask_out_(this)), (Option_9AF35E) hamr_SW_CASE_AttestationGate_thr_Impl_Bridge_dispatchTriggers_(this), (hamr_SW_CASE_AttestationGate_thr_Impl_Impl) (&t_8));
