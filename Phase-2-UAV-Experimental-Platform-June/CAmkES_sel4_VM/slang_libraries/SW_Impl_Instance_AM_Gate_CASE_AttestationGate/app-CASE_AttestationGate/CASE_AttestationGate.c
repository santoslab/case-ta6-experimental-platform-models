...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "CASE_AttestationGate.scala", "hamr.SW_Impl_Instance_AM_Gate_CASE_AttestationGate.CASE_AttestationGate", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_AM_Gate_CASE_AttestationGate_CASE_AttestationGate_main(SF &t_args);
}