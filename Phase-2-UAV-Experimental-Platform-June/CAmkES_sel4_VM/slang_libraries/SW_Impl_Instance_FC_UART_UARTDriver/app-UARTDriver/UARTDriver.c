...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "UARTDriver.scala", "hamr.SW_Impl_Instance_FC_UART_UARTDriver.UARTDriver", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_FC_UART_UARTDriver_UARTDriver_main(SF &t_args);
}