...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "CASE_Monitor_Req.scala", "hamr.SW_Impl_Instance_MON_REQ_CASE_Monitor_Req.CASE_Monitor_Req", "<App>", 0);
  ...
  return (int) hamr_SW_Impl_Instance_MON_REQ_CASE_Monitor_Req_CASE_Monitor_Req_main(SF &t_args);
}