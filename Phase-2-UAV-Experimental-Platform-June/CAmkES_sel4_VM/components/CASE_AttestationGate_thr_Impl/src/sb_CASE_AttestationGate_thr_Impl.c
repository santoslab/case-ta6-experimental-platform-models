...
bool sb_AutomationRequest_UXAS_enqueue(const union_art_DataContent *data) {
  sb_queue_union_art_DataContent_1_enqueue(sb_AutomationRequest_UXAS_queue_1, (union_art_DataContent*) data);
  sb_AutomationRequest_UXAS_1_notification_emit();

  return true;
}

bool sb_AutomationRequest_MON_REQ_enqueue(const union_art_DataContent *data) {
  sb_queue_union_art_DataContent_1_enqueue(sb_AutomationRequest_MON_REQ_queue_1, (union_art_DataContent*) data);
  sb_AutomationRequest_MON_REQ_1_notification_emit();
...
// send AutomationRequest_UXAS: Out EventDataPort CMASI__AutomationRequest_i
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_UXAS_Send(STACK_FRAME 
  art_DataContent d) {
  sb_AutomationRequest_UXAS_enqueue(d);
}

// send AutomationRequest_MON_REQ: Out EventDataPort CMASI__AutomationRequest_i
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_MON_REQ_Send(STACK_FRAME 
  art_DataContent d) {
  sb_AutomationRequest_MON_REQ_enqueue(d);
}

// send OperatingRegion_out: Out EventDataPort CMASI__OperatingRegion_i
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_out_Send(STACK_FRAME 
  art_DataContent d) {
  sb_OperatingRegion_out_enqueue(d);
}

// send LineSearchTask_out: Out EventDataPort CMASI__LineSearchTask_i
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_out_Send(STACK_FRAME 
  art_DataContent d) {
  sb_LineSearchTask_out_enqueue(d);
}

// is_empty trusted_ids: In DataPort
B hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_IsEmpty(STACK_FRAME_ONLY) {
  return sb_trusted_ids_is_empty();
}

// receive trusted_ids: In DataPort union_art_DataContent
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_Receive(STACK_FRAME
...
B hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AutomationRequest_in_is_empty();
}

// receive AutomationRequest_in: In EventDataPort union_art_DataContent
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_Receive(STACK_FRAME
  Option_8E9F45 result) {
  union_art_DataContent val;
...
B hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_OperatingRegion_in_is_empty();
}

// receive OperatingRegion_in: In EventDataPort union_art_DataContent
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_Receive(STACK_FRAME
  Option_8E9F45 result) {
  union_art_DataContent val;
...
B hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_LineSearchTask_in_is_empty();
}

// receive LineSearchTask_in: In EventDataPort union_art_DataContent
Unit hamr_SW_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_Receive(STACK_FRAME
  Option_8E9F45 result) {
  union_art_DataContent val;
...
void pre_init(void) {
  ...
  // initialise data structure for outgoing event data port AutomationRequest_UXAS
  sb_queue_union_art_DataContent_1_init(sb_AutomationRequest_UXAS_queue_1);

  // initialise data structure for outgoing event data port AutomationRequest_MON_REQ
  sb_queue_union_art_DataContent_1_init(sb_AutomationRequest_MON_REQ_queue_1);
  ...
  hamr_SW_CASE_AttestationGate_thr_Impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  hamr_SW_CASE_AttestationGate_thr_Impl_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    hamr_SW_CASE_AttestationGate_thr_Impl_adapter_computeEntryPoint(SF_LAST);
  }
  return 0;
}
