...
extern dataport_caps_handle_t sb_AutomationRequest_UXAS_AutomationRequest_queue_1_handle;
...
extern dataport_caps_handle_t sb_OperatingRegion_out_OperatingRegion_queue_1_handle;
...
extern dataport_caps_handle_t sb_AutomationResponse_MON_GEO_observed_queue_1_handle;
void sb_AutomationResponse_MON_GEO_1_notification_emit_underlying(void);
extern dataport_caps_handle_t sb_AutomationResponse_MON_REQ_observed_queue_1_handle;
...
void init_cross_vm_connections(vm_t *vm, void *cookie) {
    connections[0] = (struct camkes_crossvm_connection) {
      .handle = &sb_AutomationRequest_UXAS_AutomationRequest_queue_1_handle,
      .emit_fn = NULL,
    ...
    connections[2] = (struct camkes_crossvm_connection) {
      .handle = &sb_OperatingRegion_out_OperatingRegion_queue_1_handle,
      .emit_fn = NULL,
    ...
    connections[4] = (struct camkes_crossvm_connection) {
      .handle = &sb_AutomationResponse_MON_GEO_observed_queue_1_handle,
      .emit_fn = sb_AutomationResponse_MON_GEO_1_notification_emit_underlying,
      .consume_badge = -1
    };

    connections[5] = (struct camkes_crossvm_connection) {
      .handle = &sb_AutomationResponse_MON_REQ_observed_queue_1_handle,
